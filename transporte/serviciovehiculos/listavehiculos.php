    ...
    <?php
      ...
      if($resultado>0)
      {
        ?>
          ...
          <table class="table table-dark table-striped table-hover table-responsive-sm" border="1" id="tabla_paginada">
                ...
                <tbody id="myTable">
                  ...
                  {
                    $id=$row['id_vehiculo_mantenimiento'];
                    $marca=$row['marca'];
                    $modelo=$row['modelo'];
                    $placa=$row['no_placa'];
                    $tipo=$row['tipo']
                    ...
                    <td><center><a href="detalle_vehiculo_matenimiento.php?id=<?php echo $id?>"><button type="button" class="btn btn-info">Ver Mantenimientos</button></a></center></td>
        ...
        <?php
          ...
          <a href="../views/secritaria.php"><button type="button" class="btn btn-warning btn-lg" >Regresar</button></a>
        </center>
          <?php
      }  

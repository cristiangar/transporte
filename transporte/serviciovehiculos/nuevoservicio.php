    ...
    <br>
        ...
        <br>
            ...
            <center>
                ...
                <a href="listavehiculos.php?C"><button type="button" class="btn btn-warning" >Regresar</button></a>
    ...
    <br>
        ...
        <div class="form-row">
            ...
            <label>Descripción del servicio</label>
                <input type="text" name="descripcion" class="form-control" placeholder="Descripcion del servicio" require>
            </div>
            <div class="col-sm-10">
            <label>Costo</label>
                <input type="text" name="subtotal" class="form-control" placeholder="Costo del Servicio" require>
            </div>

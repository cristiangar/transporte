...
<?php
  include_once("../model/classbitacora.php");
  $envio=new bitacora();
  $dt=$envio->VerEnviosA();
          ...
          while ($row=mysqli_fetch_array($dt)) {
            ...
            ?>
                  ...
                  <tr>
                    ...
                    ?>
                    <td><center><a href="lista_bitacora.php?id=<?php echo $id?>"><button type="button" class="btn btn-primary">Bitacora</button></a></center></td>

...
<?php
  ...
  if($resultado>0){
      ...
      <?php
         ...
         ?>
                  ...
                  <tr>
                    ...
                    <td><center><a href="detalle_cabezal.php?id=<?php echo $id?>"><button type="button" class="btn btn-info">Detalle</button></a></center></td>
                    <td><center><a href="../controller/cabezal.php?id=<?php echo $id?>&es=E"><button type="button" class="btn btn-danger">Eliminar</button></a></center></td>
                  </tr>
                 </tbody>
                 <?php
            }     
            ...
            <center>
                 <a href="nuevo_cabezal.php"><button type="button" class="btn btn-success" >Agregar Nuevo</button></a>
    ...
    <center>
      ...
      <br>
      <a href="nuevo_cabezal.php"><button type="button" class="btn btn-success btn-lg" >Agregar Nuevo</button></a>

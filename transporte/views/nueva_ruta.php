    ...
    <br>
        <div class="form-row">
            ...
            <label>Codigo ruta</label>
                <input type="text"value="<?php echo $codigo?>" name='codigo' class="form-control" placeholder="Destino"require>
            </div> 
        </div>
            ...
            <center>
                ...
                <a href="Rutas.php"><button type="button" class="btn btn-warning" >Regresar</button></a>

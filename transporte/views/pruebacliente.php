...
<?php
  include_once("../controller/prueba.php");
          ...
          while ($row=mysqli_fetch_array($dt2)) {
            ...
            ?>
                  ...
                  <tr>
                    ...
                    <td><center><a href="pruebacliente.php?id=<?php echo $id?>&no=<?php echo $nombre?>"><button type="button" class="btn btn-primary">Seleccionar</button></a></center></td>
                  </tr>
                 </tbody>
            <?php

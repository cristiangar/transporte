const boton = document.querySelector("#boton1"),
	  ...
	  boton6 = document.querySelector("#boton6");//declaro las variables de los botones para abrir ventanas
...
const $mensajeRecibido=document.querySelector("#pagina1"),
	   ...
	   $mensajeRecibido6=document.querySelector("#pagina6");//declaro los input que voy a llenar
